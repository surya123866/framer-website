...
const Footer = () => {
  return (
    <footer className="flex justify-center items-center w-full p-5">
      <div className="flex flex-col lg:flex-row justify-center items-center bg-[#006cff] w-full lg:w-[90%] lg:h-[700px] rounded-3xl p-5 lg:p-10 gap-12">
